    ...
    <section className="bg-white py-20">
      <div className="container mx-auto px-4">
        <motion.h2
          ...
          className="font-display text-4xl text-brand-dark text-center mb-16"
        >
          How MeraRoom Works
        </motion.h2>
            ...
            return (
              <div key={step.step} className="relative flex flex-col items-center">
                ...
                <motion.div
                  ...
                  className="relative bg-white rounded-2xl p-8 text-center max-w-sm w-full"
                >
                  <span className="absolute top-4 right-6 font-display text-7xl text-brand-gold/20 select-none">
                    {step.step}
                  </span>
                  <div className="relative z-10 w-14 h-14 bg-brand-dark rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <Icon className="text-brand-gold" size={28} />
                  </div>
                  <h3 className="font-semibold text-brand-dark text-lg mb-3">
                    {step.title}
                  </h3>
